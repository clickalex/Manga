...
**Adding a chapter later:** drop `story/manga/chapter-09.md` (etc.) in the repo and add one entry to the `MANGA_CHAPTERS` list near the top of `index.html`'s script. That's all the site needs to know.
...
- **The manga** — **the pilot is complete (Ch. 1–6, 72 pages — six 12-page chapters), and Season 1 is underway: Ch. 7–8 scripted** (*The Name of the Road* · *Open Doors* — the gray takes the roads, the first named road, the first nine-realm map; the crossing walks, the white tests the Veil-water, the next road is named **HOME**). Ch. 9 continues (Vol. 3, *The First Crown*).
...
| Pilot status | **Ch. 1–6 scripted — pilot complete** (Ch. 4–6 drawn from the canon-locked outline) · **Ch. 7–8 scripted — S1 continues** (Vol. 3, *The First Crown*) |
