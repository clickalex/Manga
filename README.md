...
│       └── chapter-04-06-outline.md ← Ch. 4–6 canon-locked beat outline (pilot finale)
│
...
**Adding a chapter later:** drop `story/manga/chapter-04.md` (etc.) in the repo and add one entry to the `MANGA_CHAPTERS` list near the top of `index.html`'s script. That's all the site needs to know.
...
- **The manga** — the pilot is underway: Ch. 1–3 scripted (36 pages), Ch. 4–6 locked as a canon outline. The pilot ends with the first Re-Oath, the Nine named in the record, and the Hollow's first word.
...
| Pilot status | Ch. 1–3 scripted · Ch. 4–6 outlined (canon-locked) |
