...
- [x] Manga Ch. 10 scripted — **S1 continues** (*The Name, Spoken*: the first name-funeral at the Moot — Pick, the mountain's messenger, brings the realm's memory; KARN — Torvik's miner-old, taken at the stone-song's first crack — the name spoken, the grief kept, sealed in the Moot's ink (the Nocturne's seed, planted small); Wren rings the Voss bell at the Moot for the first time (the ending's seed, grown); the white's facing = listening — when the name is spoken, the white goes *still* (the first pause; the page, silent; the Moot's roll, stops); the river's watch set — Dew + Nereia + Roderick, the two lines together, the Chorus-True still unsung; the Third's page — the kept dark, the Moot keeps what the world cannot name; record's pentad: "Here the names are spoken.")
...
> Next: **script Chapter 11** — Season 1 continues (Vol. 3, *The First Crown*: the white is patient — it heard, and now it waits; the grief holds; the river's watch holds). The pilot's canon lock is the page itself; the outline remains the reference at [manga/chapter-04-06-outline.md](manga/chapter-04-06-outline.md).
