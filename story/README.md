...
> Next: **Chapter 15 — the count of the twelve days** (Vol. 4 continues: the Anvil-Naming closes in; the mountain is not answering; the miners are still signing; and a grummpling's one idea has been walking up a mountain with his coat buttoned). The Vol. 4 reservations — the stone-song, the Ask, Bastion's sentence, the geode, Khazri's return — are listed in [manga/README.md](manga/README.md) under "Season 2 running state."
